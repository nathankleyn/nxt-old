...
# FIXME: Remove this when debugging is done.
require "pry"
...
module NXT
  class NXT
    ...
    # Keep the connection alive and prevents NXT from going to sleep until sleep
    # time.  Also, returns the current sleep time limit in milliseconds.
    def keep_alive
